...
<form method="post" action="choose_user.php">
<!--<textarea name="msg" placeholder="type to send message..." class="form-control"></textarea><br>-->
<input type="submit" value="choose client">
</form>
<br>
<form action="index_coun.php">
<input style="width:100%;background-color:orange;color:white;font-size:20px;" type="submit" value="Don't reply">
</form>
</div>
</body>
</html>